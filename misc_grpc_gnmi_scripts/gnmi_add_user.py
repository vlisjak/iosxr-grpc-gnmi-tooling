...
new_user = {"username": "newuser2", "config": {"username": "newuser2", "password": "Test1234", "role": "root-lr"}}

oc_config = [("openconfig-system:system", {"aaa": {"authentication": {"users": {"user": new_user}}}})]
